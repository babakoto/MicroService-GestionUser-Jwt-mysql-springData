...
public class JWTAutorizationFilter extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(HttpServletRequest httpServletRequest, HttpServletResponse httpServletResponse, FilterChain filterChain) throws ServletException, IOException {
        ...
        httpServletResponse.addHeader("Access-Control-Allow-Headers","Origin,Accept,X-Requested-with,Content-Type,Access-Control-Request-Method,Access-Control-Request-Header,authorization");
        ...
        String jwtToken=httpServletRequest.getHeader(SecurityParam.JWT_HEADER_NAME);
        System.out.println("**************************************");
